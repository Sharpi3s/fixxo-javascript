        ...
        <Grid item xs={12} lg={6}>
          <div>
            ...
            <div className="d-flex align-items-center">
              <i className={`${product.rating >= 1 ? "fa-solid" : "fa-regular"} fa-star me-2`}></i>
              <i className={`${product.rating >= 2 ? "fa-solid" : "fa-regular"} fa-star me-2`}></i>
              <i className={`${product.rating >= 3 ? "fa-solid" : "fa-regular"} fa-star me-2`}></i>
              <i className={`${product.rating >= 4 ? "fa-solid" : "fa-regular"} fa-star me-2`}></i>
              <i className={`${product.rating >= 5 ? "fa-solid" : "fa-regular"} fa-star me-2`}></i>
            </div>
