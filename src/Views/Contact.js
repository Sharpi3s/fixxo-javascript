            ...
            
            {
              failedSubmit ? 
                <div className="alert alert-danger text-center" role="alert">
                  ...
                  <p>We couldn't submit your comments right now. <br />Please try again later.</p>
                </div>   : ""
            }
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="row g-3 mb-4">
            <div className="col-6">
              ...
              <div className="texts-primary">{errors.name}</div>
            </div>
            <div className="col-6">
              ...
              value={email} 
              onChange={handleChange}/>
              <div className="texts-primary">{errors.email}</div>
            </div>
            <div className="col-12">
              ...
              <div className="texts-primary">{errors.comments}</div>
            </div>
          </div>
